#Common Data Forms - CSRF PoC generator
#
# This will parse the arguments, the request headers and data, and generate
# the HTML file.
#

import sys

from allfiles import create_argument_parser
from allfiles import split_page_headers_data
from allfiles import generate_html 
